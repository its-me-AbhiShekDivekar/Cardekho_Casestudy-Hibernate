...
//		if(s.length()<=4) {
			...
			if(numflag && num.length()<=20) {
				numchoice=Long.parseLong(num);
			}
			else {
				numchoice=0;
			}
...
//		else {
//			numchoice=0;
//			System.out.println("Invalid Input More Than Four Characters");
//			
//		}	
	}
